...
|---------------|--------|------------------|
| Accuracy | ±5% | ±10% |
| Range | 0-5000 µS/cm | 0-3000 µS/cm |
...
|---------------|--------|------------------|
| Accuracy | ±0.5°C | ±1°C |
| Range | 0-50°C | 10-40°C |
| Waterproof | Required | Required |

**Options**:
| Option | Cost | Accuracy | Notes |
|--------|------|----------|-------|
| DS18B20 waterproof | $3 | ±0.5°C | One-wire protocol, easy |
| PT100 RTD | $15 | ±0.1°C | Overkill for hobby |
| Thermistor | $1 | ±1°C | Requires calibration curve |
...
| Option | Cost | Accuracy | Notes |
|--------|------|----------|-------|
| DHT22 | $5 | ±0.5°C, ±2% | Popular, adequate |
| BME280 | $8 | ±0.5°C, ±3% | Also has pressure |
| SHT31 | $12 | ±0.2°C, ±2% | More reliable than DHT |
...
|-----------|-----------|--------|------------|
| pH | <5.5 | 5.8-6.2 | >6.8 |
| EC (lettuce) | <800 µS/cm | 1000-1400 | >1800 µS/cm |
| Water temp | <15°C | 18-22°C | >26°C |
| Air temp | <18°C | 20-25°C | >30°C |
...
### EC Calibration
1. Obtain 1413 µS/cm calibration solution
2. Rinse probe with distilled water
