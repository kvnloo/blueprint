...
export const limitlessProtocol: Article = {
  ...
  content: [
    ...
    {
      type: 'text',
      text: '### Books\n- [**Ultralearning**](https://amazon.com/dp/0062852078) - Scott Young\n- [**Atomic Habits**](https://amazon.com/dp/0735211299) - James Clear\n- [**Peak**](https://amazon.com/dp/0544456238) - Anders Ericsson\n- [**Stealing Fire**](https://amazon.com/dp/0062429663) - Steven Kotler\n- [**The Art of Learning**](https://amazon.com/dp/0743277465) - Josh Waitzkin\n- [**Outlive**](https://amazon.com/dp/0593236599) - Peter Attia\n- [**Why We Sleep**](https://amazon.com/dp/1501144316) - Matthew Walker\n- [**The Art of Impossible**](https://amazon.com/dp/0062977539) - Steven Kotler\n- [**Flow**](https://amazon.com/dp/0061339202) - Mihaly Csikszentmihalyi\n\n### Researchers/Experts to Follow\n- [Steven Kotler](https://flowresearchcollective.com) (Flow Research Collective)\n- [Dr. Rhonda Patrick](https://foundmyfitness.com) (FoundMyFitness)\n- [Dr. Andrew Huberman](https://hubermanlab.com) (Huberman Lab podcast)\n- [Dr. Justin Sung](https://icanstudy.com) (iCanStudy)\n- [Dr. Peter Attia](https://peterattiamd.com) (The Drive podcast)\n- [Bryan Johnson](https://blueprint.bryanjohnson.com) (Blueprint protocol)\n\n### Tools\n- **Sleep/Biometrics**: [Oura Ring](https://ouraring.com), [WHOOP](https://whoop.com), [Eight Sleep](https://eightsleep.com), Apple Watch\n- **HRV**: [Elite HRV](https://elitehrv.com), [HRV4Training](https://hrv4training.com)\n- **Meditation**: [Reveri](https://reveri.com) app (NSDR), [Muse](https://choosemuse.com) headband, [Waking Up](https://wakingup.com), [Headspace](https://headspace.com)\n- **Learning**: [Anki](https://apps.ankiweb.net), [Readwise](https://readwise.io), [Roam](https://roamresearch.com)\n- **Focus**: [Forest](https://forestapp.cc), [Freedom](https://freedom.to), [Cold Turkey](https://getcoldturkey.com)\n- **Metabolism**: [Levels](https://levels.link), [Dexcom](https://dexcom.com) CGM (continuous glucose monitoring)\n- **Visual Training**: [Senaptec](https://senaptec.com) Strobe glasses'
    },
    {
      type: 'text',
